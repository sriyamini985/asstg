  ...
  const html = `
    ...
    <head>
      ...
      <style>
        ...
        .card { max-width: 500px; margin: 20px auto; background-color: #1e293b; border: 1px solid #334155; border-radius: 16px; padding: 28px 24px; box-shadow: 0 10px 25px rgba(0,0,0,0.3); }
        .p-text { font-size: 15px; color: #e2e8f0; margin: 0 0 16px 0; line-height: 1.5; }
        .red-box { background-color: #451a03; border: 1px solid #b45309; border-radius: 12px; padding: 18px 20px; margin: 24px 0; text-align: left; }
        .box-title { font-size: 14px; font-weight: 600; color: #fcd34d; margin: 0 0 6px 0; }
        .box-desc { font-size: 15px; font-weight: bold; color: #fef08a; margin: 0; line-height: 1.4; }
        .footer-text { margin-top: 24px; color: #e2e8f0; font-size: 15px; line-height: 1.6; }
        .asst-tag { background-color: #78350f; color: #fbbf24; font-weight: bold; padding: 2px 6px; border-radius: 4px; display: inline-block; }
      </style>
    </head>
    <body>
      <div class="card">
        <p class="p-text">Dear ${fullName},</p>
        <p class="p-text">Your registration payment proof could not be verified.</p>
        <p class="p-text">Your registration status has been updated to Rejected.</p>
        
        <div class="red-box">
          <div class="box-title">Admin Remarks / Reason:</div>
          <div class="box-desc">${remarks || 'Payment screenshot mismatch or transaction details could not be verified.'}</div>
        </div>

        <p class="p-text">If you have any questions, please reply to this email or re-upload your valid payment screenshot.</p>
...
export const sendMembershipApprovedEmail = async (membership) => {
  ...
  const memberName = membership.name || 'Member';
  ...
  const html = `
    ...
    <head>
      ...
      <style>
        ...
        .green-box { background-color: #064e3b; border: 1px solid #047857; border-radius: 12px; padding: 18px 20px; margin: 24px 0; text-align: left; }
        .box-title { font-size: 14px; font-weight: 600; color: #6ee7b7; margin: 0 0 6px 0; }
        .box-id { font-size: 20px; font-weight: 800; color: #34d399; margin: 0; letter-spacing: 0.5px; }
        .footer-text { margin-top: 24px; color: #e2e8f0; font-size: 15px; line-height: 1.6; }
        .asst-tag { background-color: #78350f; color: #fbbf24; font-weight: bold; padding: 2px 6px; border-radius: 4px; display: inline-block; }
      </style>
    </head>
    <body>
      <div class="card">
        <p class="p-text">Dear ${memberName},</p>
        <p class="p-text">Your payment has been verified successfully.</p>
        <p class="p-text">Your ASST membership has been approved.</p>
        
        <div class="green-box">
          <div class="box-title">Membership Category:</div>
          <div class="box-id">${membershipType}</div>
        </div>
...
export const sendMembershipRejectedEmail = async (membership, remarks) => {
  const subject = `Membership Application Rejected`;
  const memberName = membership.name || 'Applicant';
  ...
  const html = `
    ...
    <body>
      <div class="card">
        <p class="p-text">Dear ${memberName},</p>
        <p class="p-text">Your membership payment proof could not be verified.</p>
        <p class="p-text">Your membership application status has been updated to Rejected.</p>
        
        <div class="red-box">
          <div class="box-title">Admin Remarks / Reason:</div>
          <div class="box-desc">${remarks || 'Payment or application details could not be verified.'}</div>
        </div>

        <p class="p-text">If you have any questions, please reply to this email or contact us at info@asstg.in.</p>
